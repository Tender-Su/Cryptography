...
# Form implementation generated from reading ui file 'd:\OneDrive\我Python牛皮\密码学实验\4SM4\SM4.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.mw2.setGeometry(QtCore.QRect(60, 130, 381, 61))
        self.mw2.setObjectName("mw2")
        self.my = QtWidgets.QTextEdit(self.centralwidget)
        self.my.setGeometry(QtCore.QRect(60, 90, 381, 31))
        ...
        self.jm.setGeometry(QtCore.QRect(60, 290, 75, 23))
        self.jm.setObjectName("jm")
        self.qk = QtWidgets.QPushButton(self.centralwidget)
        self.qk.setGeometry(QtCore.QRect(350, 290, 75, 23))
        self.qk.setObjectName("qk")
        self.jmw = QtWidgets.QTextEdit(self.centralwidget)
        self.jmw.setGeometry(QtCore.QRect(60, 200, 381, 61))
        self.jmw.setObjectName("jmw")
        self.label_5 = QtWidgets.QLabel(self.centralwidget)
        self.label_5.setGeometry(QtCore.QRect(20, 210, 41, 21))
        self.label_5.setObjectName("label_5")
        self.jm2 = QtWidgets.QPushButton(self.centralwidget)
        self.jm2.setGeometry(QtCore.QRect(200, 290, 75, 23))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "SM4"))
